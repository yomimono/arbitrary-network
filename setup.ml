...
(* OASIS_START *)
(* DO NOT EDIT (digest: beb49f5d79474719713942cdb5765a77) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "arbitrary constructors use with randomized testing and mirage";
          description =
            Some
              [
                 OASISText.Para
                   "provide generators for random, but structured, data"
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "#\025Å:^H»\011<\158è\019>®ÎD";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
